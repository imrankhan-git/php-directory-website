            ...
            <div class="container main-container">
                    <div class="col-lg-offset-1 col-lg-11 col-md-12 col-sm-12 col-xs-12">
                        <ul class="nav nav-pills ">
                            <li class="active"><a data-toggle="tab" href="#register-account" style="font-size:35px !important;">Forgot Password for Brokers</a></li>
                        </ul>
                            ...
                            <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12  pull-right sidebar">
                            	<div class="widget">
                                    ...
                                    <ul>
										...
										<li>
                                        <a href="join_as_broker.php" class="label job-type register" id="register">Register</a>
...
<!-- broker forgot password ad -->
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-5344954780416051"
     data-ad-slot="1116517571"
     data-ad-format="auto"
		...
		$(document).ready(function() {
			...
			$('#recoverform').on('submit', function(e) {
				...
				else
				{
					spinner.show();
					$.ajax({
						url: "phpfiles/brokerforgotpassword.php",
						type: "POST",
