...
include "../dbconfig.php";
			...
			$output .= '<div class="filter-result 01" class=" li-post-group">
							<div class="col-lg-6 col-md-6 col-sm-7 col-xs-12 pull-left">
							   <div class="company-left-info pull-left">
								...
								<div class="desig">
									<h3>'.$broker_first_name.' '.$broker_last_name.'</h3>
									<h4>'.$string.'</h4>
								</div>
							</div>
	...
	{
		$output = '<div class="text-center col-md-12" style="text-align: center;"><img src="assets/images/norec1.png" class="img-responsive col-md-4 col-md-offset-4 text-center" alt="No Records!" style="text-align: center;"></div>';
