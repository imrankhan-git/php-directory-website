			...
			<div class="row green-banner">
            	<div class="container main-container">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                		<h3 class="white-heading">500 - Server Error</h3>
                    </div>
                </div>
            </div> 
        </div>
            	...
            	<div class="container main-container-job">
                	<div class="col-lg-12 col-md-12 col-sm-12">
					    <div class="text-center">
							...
							<p class="text-center">We are hardly working to solve this problem</p>

							<p class="text-center">Please come back after 30 minutes</p>
						</div>
                    	<div class="post-image" style="align:center !important;">
                        	<img src="assets/images/500.gif" alt="Kalyanabrokers"/>
                        </div>
                        <div class="content">
...
================================================== -->
	...
	$(document).ready(function() {
		...
		$('#offersendform').on('submit', function(e) {
			e.preventDefault();
			var inputname = document.getElementById("offeremail").value;
			...
			else
			{
				spinner.show();
				$.ajax({
					url: "phpfiles/offer_subscribe.php",
					type: "POST",
