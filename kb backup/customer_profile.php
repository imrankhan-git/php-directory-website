...
<head>
    ...
    <title>KB - Customer Profile</title>
			...
			<div class="row section-title">
            	<div class="container main-container">
                	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                		<h3 class="image-heading"><?php echo $customerfirstname.' '.$customerlastname; ?> Profile</h3>
                    </div>
                </div>
            </div>  
            	...
            	<div class="container main-container gery-bg">
            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  no-padding user-data">
                        <div class="seprator ">
                            ...
                            <div class="user-tag"><?php echo $customerfirstname.' '.$customerlastname; ?><span> Customer</span></div>
                        </div>
						<div class="seprator">
                            <div class="user-tag"><label>Email<span><?php echo $customeremail; ?></span></label></div>
                       	</div>
                        <div class="seprator">
                            <div class="user-tag"><label>Mobile<span><?php echo $customermobile; ?></span></label></div>
                       	</div>
                	</div>
            </div>
            </div>       
								...
								<div class="alert alert-primary" id="responsemessage" style="display:none;"><i class="ti-user"></i>
								   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    ...
                                    <div class="form-group">
                                        <input type="text" value="<?php echo $customerfirstname; ?>" name="customerfirstname" id="customerfirstname" placeholder="Customer First name"/><br/>
										<input type="text" value="<?php echo $customerlastname; ?>" name="customerlastname" id="customerlastname" placeholder="Customer Last name"/><br/>
										<input type="text" value="<?php echo $customermobile; ?>" name="customermobile" id="customermobile"placeholder="Customer mobile"/><br/>
										<input type="hidden" value="<?php echo $customeremail; ?>" name="customeremail" id="customeremail"/><br/>
										<input type="hidden" value="<?php echo $customerid; ?>" name="customerid" id="customerid"/><br/>
                                        <button type="submit" class="btn btn-print bg-blue">Update Profile</button>
                                    </div>
                                </form>
								<p><a href="forgot_password.php">Click here to Change your password?</a></p>
                            </div>
                        </div>
                         </div>
                    </div>
	...
	$(document).ready(function() {
		...
		$('#customerprofileform').on('submit', function(e) {
			...
			else
			{
				spinner.show();
				$.ajax({
					url: "phpfiles/updatecustomerprofile.php",
					type: "POST",
