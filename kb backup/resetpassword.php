            ...
            <div class="container main-container-home">
                    <div class="col-lg-offset-1 col-lg-11 col-md-12 col-sm-12 col-xs-12">
                        <ul class="nav nav-pills ">
                            <li class="active"><a data-toggle="tab" href="#register-account">Reset your Password</a></li>
                        </ul>
                    <div class="tab-content">
                        <div id="login" class="tab-pane fade in active white-text">
                            ...
                            <div class="form-group submit">
                                ...
                                <a href="join_as_customer_login.php" class="lost_password">Remember Password?</a>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12  pull-right sidebar">
                            	<div class="widget">
                                    ...
                                    <ul>
										...
										<li>
                                        <a href="join_as_customer_register.php" class="label job-type register">Register</a>
						...
						$.ajax({
							...
							success: function(response) {
								...
								if(status == 1)
								{
									...
									window.location.href = "join_as_customer_login.php";
								}
								else
								{
									$('#responsemessage').html(message).css({"font-weight": "bold","display": "block"});
